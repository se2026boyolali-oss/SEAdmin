...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50">
      ...
      {/* SIDEBAR: Hanya dirender jika BUKAN PCL */}
      {!isPcl && (
        <div className="w-64 bg-slate-900 text-white flex flex-col transition-all shrink-0">
          {/* Brand Header */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-14 bg-white border-b flex items-center justify-between px-4 sm:px-6 shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* TOMBOL LOGOUT KHUSUS PCL: Muncul di Header karena Sidebar di-hide */}
            {isPcl && (
              <button
                onClick={handleLogout}
